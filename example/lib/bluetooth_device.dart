...
class BluetoothDeviceItem extends StatelessWidget {
  ...
  Future<void> pairDevice() async {
    try {
      print("Pairing");
      bool paired = await BluetoothAccessoryManager.pair(device.address);
      print("Pair: $paired");
    } catch (e) {
      print(e);
    }
  ...
  Future<void> unPairDevice() async {
    try {
      ...
      await BluetoothAccessoryManager.unpair(device.address);
      print("Unpaired");
    } catch (e) {
      print(e);
    }
  ...
  Future<void> disconnect() async {
    print("Disconnecting");
    await BluetoothAccessoryManager.disconnect(device.address);
    print("Disconnected");
  }
  ...
  Future<void> connect() async {
    try {
      print("Connecting");
      await BluetoothAccessoryManager.connect(device.address);
