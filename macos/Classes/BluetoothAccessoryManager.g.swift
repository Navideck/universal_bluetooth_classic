...
private class BluetoothAccessoryManagerPigeonCodecReader: FlutterStandardReader {
...
private class BluetoothAccessoryManagerPigeonCodecWriter: FlutterStandardWriter {
...
private class BluetoothAccessoryManagerPigeonCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return BluetoothAccessoryManagerPigeonCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return BluetoothAccessoryManagerPigeonCodecWriter(data: data)
  }
}

class BluetoothAccessoryManagerPigeonCodec: FlutterStandardMessageCodec, @unchecked Sendable {
  static let shared = BluetoothAccessoryManagerPigeonCodec(readerWriter: BluetoothAccessoryManagerPigeonCodecReaderWriter())
}
...
class FlutterAccessoryPlatformChannelSetup {
  static var codec: FlutterStandardMessageCodec { BluetoothAccessoryManagerPigeonCodec.shared }
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: FlutterAccessoryPlatformChannel?, messageChannelSuffix: String = "") {
    ...
    let showBluetoothAccessoryPickerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryPlatformChannel.showBluetoothAccessoryPicker\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let startScanChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryPlatformChannel.startScan\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let stopScanChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryPlatformChannel.stopScan\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isScanningChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryPlatformChannel.isScanning\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getPairedDevicesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryPlatformChannel.getPairedDevices\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let pairChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryPlatformChannel.pair\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let unpairChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryPlatformChannel.unpair\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class FlutterAccessoryCallbackChannel: FlutterAccessoryCallbackChannelProtocol {
  ...
  var codec: BluetoothAccessoryManagerPigeonCodec {
    return BluetoothAccessoryManagerPigeonCodec.shared
  }
  func onDeviceDiscover(device deviceArg: BluetoothDevice, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryCallbackChannel.onDeviceDiscover\(messageChannelSuffix)"
  ...
  func onDeviceRemoved(device deviceArg: BluetoothDevice, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.bluetooth_accessory_manager.FlutterAccessoryCallbackChannel.onDeviceRemoved\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([deviceArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
